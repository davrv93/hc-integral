    ...
    <div className="flex flex-col gap-4">
      <div className="rounded-card border border-border bg-surface p-4">
        ...
        <Controller
          ...
          render={({ field }) => (
            <SegmentedControl label="Plan de trabajo" options={EVAL_OPTIONS} value={field.value} onChange={field.onChange} />
          )}
        />
      </div>
      ...
      <div className="rounded-card border border-border bg-surface p-4">
        ...
        <Controller
          ...
          render={({ field }) => (
            <SegmentedControl label="Objetivos" options={EVAL_OPTIONS} value={field.value} onChange={field.onChange} />
          )}
        />
      </div>
